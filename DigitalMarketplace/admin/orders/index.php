                ...
                <table class="table table-bordered table-striped">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="p1 text-center">Shipping Cost</th> <!-- Added column -->
                    ...
                    <tbody>
                        ...
                        while ($row = $orders->fetch_assoc()):
                            $shippingCost = 50.00; // Example shipping cost value
                            $totalAmount = $row['total_amount'] + $shippingCost; // Calculate total amount including shipping cost
                        ?>
                            <tr>
                                ...
                                <td class="px-2 py-1 align-middle text-right"><?= format_num($shippingCost) ?></td> <!-- Display shipping cost -->

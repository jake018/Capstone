...
<div class="container-fluid">
    ...
    <div id="order-list" class="row">
        ...
        $shippingCost = 50.00; // Set the shipping cost value
        $gtotal += $shippingCost; // Add the shipping cost to the grand total
        ?>
        <div class="col-12 border">
            <div class="d-flex">
                <div class="col-9 h4 font-weight-bold text-right text-muted">Shipping Cost</div>
                <div class="col-3 h4 font-weight-bold text-right"><?= format_num($shippingCost) ?></div>
            </div>
        </div>
        <div class="col-12 border">
            <div class="d-flex">

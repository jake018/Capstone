...
<body class="hold-transition">
  ...
  <div class="d-flex justify-content-center align-items-center flex-column min-vh-50">
    <div class="col-md-5 m-0"></div>
    <div class="col-md-7 bg-gradient-light px-4">
        <div class="d-flex justify-content-center align-items-center h-80">
            <div class="card card-outline card-primary col-12 rounded-0 shadow">
                <div class="card-header text-center m-2">
                    <a href="./register.php" class="h1"><h2>Create an Account</h2></a>
          </div>
          <div class="card-body">
            ...
            <form id="cregister-frm" action="" method="post">
              ...
              <div class="row">
                <div class="form-group col-md-3">
                  ...
                  <input type="text" id="firstname" autofocus name="firstname" class="form-control" required>
                </div>
                ...
                <div class="form-group col-md-4">
                  ...
                  <select type="text" id="gender" name="gender" class="form-control  select2" required>
                    <option>Male</option>

                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-7 col-sm-12">
                        ...
                        <div class="d-flex w-100">
                            ...
                            <div class="col-auto px-0 flex-shrink-1 flex-grow-1"><p class="m-0"><h6 class="text-muted"><?= $vendor ?></h6></p></div>
                        </div>
                        <div class="d-flex">
                            <div class="col-auto px-0"><h7 class="text-muted">Category : </h7></div>
                            <div class="col-auto px-0 flex-shrink-1 flex-grow-1"><p class="m-0"><h7 class="text-muted"><?= $category ?></h7></p></div>
                        </div>
                        <div class="d-flex">
                            <div class="col-auto px-0"><h5class="text-muted">Price: ₱</h5></div>
                            <div class="col-auto px-0 flex-shrink-1 flex-grow-1"><p class="m-0 pl-3"><h5 class="text-primary"><?= format_num($price) ?></h5></p></div>
                        </div>

                ...
                <table class="table table-bordered table-striped">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="p1 text-center">Payment Method</th>
                    ...
                    <tbody>
                        ...
                        while ($row = $orders->fetch_assoc()):
                            $totalAmount = $row['total_amount'] // Adding shipping cost to the total amount
                        ?>
                        <tr>
                            ...
                            <td class="px-2 py-1 align-middle text-right">
                                Total: <?= format_num($row['total_amount']) ?><br>
                                <b>Total Amount: <?= format_num($totalAmount) ?></b>
                            ...
                            <td class="px-2 py-1 align-middle text-center">
                                ...
                                switch($row['status']){
                                    ...
                                    case 4:
                                        ...
                                        break;
                                    case 5:
                                        echo '<span class="badge badge-danger bg-gradient-danger px-3 rounded-pill">Waiting for Payment</span>';
                                        break;
                                        case 6:
                            ...
                            <td class="px-2 py-1 align-middle"><?= $row['payment_method'] ?></td>
                            <td class="px-2 py-1 align-middle text-center">

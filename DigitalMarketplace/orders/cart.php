...
<div class="content py-3">
    <div class="card card-outline card-primary rounded-0 shadow-0">
        ...
        <div class="card-body">
            <div id="cart-list">
                <form action="checkout_process.php" method="post"> <!-- Assuming checkout_process.php is the script that handles the checkout -->
                <div class="row">
                <?php 
                $gtotal = 0;
                ...
                ?>
                    <div class="col-12 border">
                        <label>
                            <input type="checkbox" name="selected_vendors[]" value="<?= $vrow['id'] ?>">

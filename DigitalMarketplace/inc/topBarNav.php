...
<!-- Navbar -->
      ...
      <nav class="w-100 px-2 py-1 position-fixed top-0 bg-blue text-light" id="login-nav">
          ...
          <div>
            <?php if($_settings->userdata('id') > 0 && $_settings->userdata('login_type') ==3): ?>
              ...
              <div class="dropdown">
                ...
                <span class="mx-2"><img src="<?= validate_image($_settings->userdata('avatar')) ?>" class="img-thumbnail rounded-circle" alt="User Avatar" id="client-img-avatar">  <span class="mx-2">Welcome !<?= !empty($_settings->userdata('username')) ? $_settings->userdata('username') : $_settings->userdata('email') ?></span>
                </a>
      ...
      <nav class="main-header navbar navbar-expand-md navbar-light border-0 text-sm bg-gradient-light shadow" id='top-Nav'>
        ...
        <div class="container">
          ...
          <div class="collapse-danger navbar-collapse order-3" id="navbarCollapse"  >
            <!-- Left navbar links -->
            <ul class="navbar-nav">
              <li class="nav-item ">
              ...
              <li class="nav-item">
                ...
                ?>
                <a href="./?page=orders/cart" class="nav-link <?= isset($page) && $page =='orders/cart' ? "active" : "" ?>"><span class="badge badge-danger rounded-cirlce"><?= format_num($cart_count) ?></span><i class=" fa-cart-shopping"></i> Cart</a>
              </li>
              <li class="nav-item">

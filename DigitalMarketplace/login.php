...
<body class="hold-transition login-page">
  ...
  <div class="loader">
    <!-- Insert your loader/spinner HTML code here -->
    <!-- For example: -->
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="./login.php" class="h1 text-decoration-none"><b>Users</b></a>
    </div>
    <div class="card-body">
      <form id="cclogin-frm" action="" method="post">
        ...
        <div class="row align-item-end">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-danger btn-block btn-pointer">Sign In</button>
          </div>
